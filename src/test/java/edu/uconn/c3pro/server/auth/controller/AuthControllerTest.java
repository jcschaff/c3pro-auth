...
public class AuthControllerTest {
 	...
 	public void test_authController() throws UnsupportedEncodingException {
  		...
  		final String BEARER_TOKEN = "mybearertoken";
		...
		Mockito.when(credentialGenerator.generateJwtBearerToken(CLIENT_ID)).thenReturn(BEARER_TOKEN);
  		...
  		authController.credentialGenerator = credentialGenerator;
 		...
 		Assertions.assertThat(response.getBody().getAccess_token().equals(BEARER_TOKEN));
 	}
